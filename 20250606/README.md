...
2. 最新の Workflow「 Algorithm-Seminar-2025-06-06 (自分のユーザ名) 」を開く

<img src="../assets/images/How-To-Use-GitHub-Actions-2.png" width="800" align="center">

3. 採点結果の詳細を確認する場合は「 Algorithm-Seminar-2025-06-06 」を開く
...
6. 全ての課題の正解 or 不正解を確認する場合は「 Report Algorithm-Seminar-2025-06-06 」を開く
